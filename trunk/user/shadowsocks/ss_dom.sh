https://raw.githubusercontent.com/v2fly/domain-list-community/release/gfwlist.txt
https://cdn.jsdelivr.net/gh/v2fly/domain-list-community@release/gfwlist.txt
